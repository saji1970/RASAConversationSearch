...
It contains two tables: prod and product description, so both the tables contain product information.
...
JUST ANSWER WITH JSON. Ensure to handle variations in keywords and phrases, such as "cashback" vs "cash back" and "annual fee" vs "yearly fee". Match keywords flexibly to account for different forms of the same concept and provide a fail-safe mechanism to prevent errors.
"""
